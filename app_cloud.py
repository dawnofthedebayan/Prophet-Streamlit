...
def load_precomputed_data():
    """Load precomputed Prophet results."""
    results_path = "precomputed/prophet_results.pkl"
    options_path = "precomputed/param_options.pkl"
    
    if not os.path.exists(results_path):
        st.error("⚠️ Precomputed data not found! Run `python precompute.py` first.")
        st.stop()
...
def main():
    ...
    # Load precomputed data
    results, options = load_precomputed_data()
